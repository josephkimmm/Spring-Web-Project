...
<style>
        ...
        .th-date {
    	font-size: 18px; /* 작성일자: 작게 */
		}

		.th-title {
   		 font-size: 21px; /* 제목: 더 크게 */
		}
...
<body>
    ...
    <table>
        <thead>
            <tr>
                <th class="th-date">작성 일자</th>
                <th class="th-title">제목</th>
                <th>
                <select  class="action-select">
                    <option value="newest">최신순</option>
                    <option value="oldest">오래된 순</option>
                    <option value="lessAttending">적게 참여한 순</option>
                    <option value="severalTimesAttending">많이 참여한 순</option>
                    <option value="arrange">가나다순</option>
                </select>
                </th> 
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>2025년 3월 24일</td>
                <td>3월 24일 역삼역에서 삼겹살 드실분 구합니다!!!</td>
                <td>
            ...
            <tr>
                <td>2025년 3월 24일</td>
                <td>3월 28일 역삼역에서 치킨 드실분 구합니다!!!</td>
                <td>
                   <button class="action-btn">수정</button>
                   <button class="action-btn">삭제</button>
                </td>
