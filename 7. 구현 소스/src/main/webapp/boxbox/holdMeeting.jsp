...
<style>
		...
		/* 두 번째 행 (row-2) 스타일 */
		.row-2 td {
   		 color: #b0adc0; /* 텍스트 색상: 회색 */
		}

		.row-2 .action-btn {
    	background-color: #c81e1e; /* 버튼 배경색: 빨강색 */
    ...
    <table>
        ...
        <tbody>
            <tr class="row-1">
                ...
                <td>5명</td>
                <td>
                   <button class="action-btn">모임 참여 현황</button>
                </td>
            </tr>
             <tr class="row-2">
                <td>2025년 3월 31일</td>
                ...
                <td>3명</td>
                <td>
                   <button class="action-btn finish">종료된 모임</button>
                </td>
            </tr>
            <!-- 추가 데이터가 여기에 들어갑니다. -->
        </tbody>
