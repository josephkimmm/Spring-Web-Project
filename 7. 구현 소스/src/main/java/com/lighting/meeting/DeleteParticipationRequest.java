...
@WebServlet("/meeting/deleteparticipationrequest.do")
public class DeleteParticipationRequest extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int result = dao.deleteParticipationRequest(dto);
        dao.close();
