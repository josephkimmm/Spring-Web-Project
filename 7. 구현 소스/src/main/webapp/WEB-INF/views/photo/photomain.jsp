...
.gallery img {
	width: 100%; /* 이미지가 div를 100% 차지하도록 설정 */
	height: 100%; /* 비율에 맞게 세로 길이 자동 조정 */
...
<body>
	...
	<div class="container">
		<div class="tabs">
			<a href="/lighting/photomain.do" class="tab">오늘어때 이미지 갤러리</a> <a
				href="/lighting/photomypage.do" class="tab" style="opacity: 0.6">내
				이미지 보기</a> <select class="dropdown">
				<option>최신순</option>
				<option>오래된 순</option>
				<option>조회 순</option>
			</select>
		...
		<div class="gallery" id="imageGallery">
			<c:forEach var="dto" items="${photoList}">
				<div>
					<img src="/lighting/webapp/images/${dto.photoFileName}"
						onclick="showImageModal('/lighting/webapp/images/${dto.photoFileName}')"
						alt="업로드된 이미지">
				</div>
			</c:forEach>
		</div>
	...
	<!-- 이미지 업로드 모달 -->
	<form action="/lighting/photo/photomainok.do" method="post" enctype="multipart/form-data">  
	<div class="modal-overlay" id="uploadModal">
		<div class="modal">
			...
			<button class="btn btn-primary" onclick="uploadImage()" type="submit">이미지
				업로드</button>
		</div>
	</div>
</form>
